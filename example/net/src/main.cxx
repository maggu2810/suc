...
{
    int tcp_client =
        suc::net::create_connected_socket(suc::net::socket_type::tcp, "google.com", 80, false);
    int udp_client =
        suc::net::create_connected_socket(suc::net::socket_type::udp, "google.com", 80, false);
